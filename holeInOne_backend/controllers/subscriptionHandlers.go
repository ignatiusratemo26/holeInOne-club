...
func init() {
	...
	subscriptionsCollection = client.Database("holeInOneDB").Collection("subscriptions")
	userSubscriptionsCollection = client.Database("holeInOneDB").Collection("user_subscriptions")
}
